    ...
    const fetchScooters = async () => {
      try {
        ...
        const response = await fetch(
          `https://store.maator.com/wp-json/wp/v2/used?acf_format=standard&_fields=acf,id,slug&per_page=${itemsPerPage}&page=${page}`
        );

        // Get WP total pages from headers
            ...
            : scooters.map((scooter) => (
                <div key={scooter.id} className="overflow-hidden">
                  ...
                  <div className="p-2 text-center">
                    ...
                    <button
                      onClick={() => {
                        router.push(`/${locale}/used/${scooter.slug}`);
                      }}
